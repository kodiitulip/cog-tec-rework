...
export const Card = ({ id, title, imageSrc, onClick, disabled, active }: Props) => {
  return (
    <button
      onClick={() => onClick(id)}
      className='h-full border-2 rounded-xl border-b-4 hover:bg-black/5 cursor-pointer active:border-b-2 flex flex-col items-center justify-between p-3 pb-6 min-h-54.25 min-w-50 disabled:pointer-events-none disabled:opacity-50'
      disabled={disabled}
    >
